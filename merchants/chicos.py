...
class Parser(MerchantParser):
    ...
    def _prices(self, prices, item, **kwargs):
        ...
        listprice = prices.xpath('./span[@class="product-price"]//text()').extract_first()
...
class Config(MerchantConfig):
    ...
    list_urls = dict(
        f = dict(
            a = [
                "https://www.chicos.com/store/category/view+all/cat40005/?page={}"               
                ],
            c = [
                "https://www.chicos.com/store/category/clothing/cat11199290/?page={}",
            ],
        )
    )
